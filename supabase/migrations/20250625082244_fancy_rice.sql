/*
  # Fix Date-Specific Seat Booking System

  1. Database Functions
    - Create improved seat availability function
    - Fix seat status logic for date-specific bookings
    - Add proper seat filtering by travel date

  2. Frontend Integration
    - Update seat selection to use travel date
    - Fix seat status display logic
    - Ensure proper date filtering

  3. Backend Updates
    - Update seat models to handle date filtering
    - Fix seat locking with travel dates
    - Improve seat availability queries
*/
