/*
  # Fix Payment Processing and Seat Booking

  1. Database Functions
    - Create robust payment processing trigger
    - Fix seat booking logic
    - Add proper error handling

  2. Webhook Processing
    - Ensure payment status updates trigger booking confirmation
    - Properly book seats with travel dates
    - Handle all payment status transitions

  3. Data Consistency
    - Fix existing pending bookings with successful payments
    - Ensure seats are properly booked
